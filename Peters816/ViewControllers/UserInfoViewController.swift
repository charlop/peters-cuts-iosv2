...
class userInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let extName = userDefaults.userName
        let extPhone = userDefaults.userPhone
        let extEmail = userDefaults.userEmail
    ...
    @IBAction func saveButtonActionWithSender(_ sender: AnyObject) {
        if let name = nameField.text {
            if let phone = phoneField.text {
                userDefaults.saveUserDetails(name: name, phone: phone, email: emailField.text!)
